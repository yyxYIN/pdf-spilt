...
def spilt_pdf(read_file, output_path, out_page_nums):
    ...
    try:
        ...
        loop_num = math.floor(page_count / out_page_nums)
        ...
        if last_pages_num != 0:
            ...
            try:
                ...
                with open(pdf_output_name, 'wb') as sub_fp:
                    pdf_output_file.write(sub_fp)
                logging.info('完成分割%d到%d页', out_page_nums * loop_num + 1, out_page_nums * loop_num + last_pages_num)
            except IndexError as e:
                logging.debug(e)
...
if __name__ == "__main__":
    FILE_NAME = "C:\\Users\\42035\Desktop\\gooddellow\\Goodfellow - 2016 - NIPS 2016 Tutorial Generative Adversarial Networks.pdf"
    output_path = "C:\\Users\\42035\Desktop\\gooddellow"
    spilt_pdf(FILE_NAME, output_path, 20)